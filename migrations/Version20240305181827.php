 ...
 */
final class Version20240305181827 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_2CEB8E0E71F7E88B ON image_event (event_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_2CEB8E0E71F7E88B ON image_event');
