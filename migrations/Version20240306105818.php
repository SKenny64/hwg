...
final class Version20240306105818 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE adresse (id INT AUTO_INCREMENT NOT NULL, adresse LONGTEXT DEFAULT NULL, complement LONGTEXT DEFAULT NULL, ville VARCHAR(150) DEFAULT NULL, code_postal VARCHAR(20) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
